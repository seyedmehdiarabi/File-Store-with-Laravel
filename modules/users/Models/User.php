...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'mobile', 'password', 'account_status', 'active_code', 'role', 'role_id', 'username', 'forget_password_code', 'last_login_at', 'last_login_ip', 'reagent', 'wallet', 'block_amount', 'type'
    ];
